...
import sys
    ...
    Description: After classifying the individual positions of the ODA, this script rotates the ODA from the "top right" position to the "top left" position. Do not forget to
...
def invert_tilt_and_adjust_rot_in_star(input_file, output_file):
    ...
    data['_rlnAngleRot'] = (-data['_rlnAngleRot']) - 55
