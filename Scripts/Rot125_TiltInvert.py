...
import sys
    ...
    Description: After classifying the individual positions of the ODA, this script rotates the ODA from the "bottom left" position to the "top left" position. Do not forget to
