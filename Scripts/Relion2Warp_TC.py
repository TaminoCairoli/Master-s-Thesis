...
from io import StringIO
    ...
    Description: The script converts a Relion5 compatible .star file into a Warp compatible .star file. It converts the rlnCenteredCoordinate into a rlnCoordinate.
