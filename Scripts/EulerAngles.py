...
"""
    ...
    Description: This script works with rotation matrices to modify the euler angles and also the shifts of the input particles. It required warp comparticle coordinated, the InputFile 
    should be generated by the Relion2Warp_TC.py script. 
    Execute ==> Example; Rotation around rot angle by 180° : python3 EulerAngles.py -i InputFile.star -o OutputFile.star -s 0 0 0 -r 180 0 0
    """
