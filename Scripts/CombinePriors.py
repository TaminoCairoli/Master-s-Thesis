...
"""
    ...
    Description: The script combines prior information from crYOLO picked particles with a Relion5 compatible .star file. The InputFile_WithPriors.star file must be generated
    with the "coords2star.py" script from crYOLO (https://cryolo.readthedocs.io/en/stable/tutorials/tutorial_overview.html#extraction ==> Section 7, option 2, last visited: 04.04.2025).
    The InputFile_NoPriors.star must be generated by importing the crYOLO output coordianted from the "COORDS_TRACED" folder into Relion5. The input coordinates are then Extracted
    at a desired binning value. The extracted .star file served as InputFile_NoPriors.star.

    The script outputs two files:    1.) particles_warp_sorted.star is a quality control to double check at all tomograms are in the right order.
                                     2.) particles_modified.star is the InputFile_WithPriors.star file. 
